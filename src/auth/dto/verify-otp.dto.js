...
class VerifyOtpDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { phone: { required: true, type: () => String, pattern: "^\\+?\\d{8,16}$" }, code: { required: true, type: () => String, minLength: 6, maxLength: 6, pattern: "^\\d{6}$" } };
    }
}
exports.VerifyOtpDto = VerifyOtpDto;
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Matches)(/^\+?\d{8,16}$/, {
