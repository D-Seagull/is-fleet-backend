...
const messages: Record<Locale, Record<string, string>> = {
  uk: {
    ...
    'push.tripStatusTitle': 'Статус рейсу',
    'push.tripStatusBody': '{{plate}}: {{status}}',
    'tripStatus.ASSIGNED': 'Призначено',
    'tripStatus.ACCEPTED': 'Прийнято',
    'tripStatus.ON_WAY': 'У дорозі',
    'tripStatus.ON_SITE': 'На місці',
    'tripStatus.LOADED': 'Завантажено',
    'tripStatus.DELIVERED': 'Доставлено',
    // errors — not found
    'errors.tripNotFound': 'Рейс не знайдений',
    'errors.documentNotFound': 'Документ не знайдений',
    'errors.fileMissing': 'Файл більше не доступний',
  ...
  en: {
    ...
    'push.tripStatusTitle': 'Trip status',
    'push.tripStatusBody': '{{plate}}: {{status}}',
    'tripStatus.ASSIGNED': 'Assigned',
    'tripStatus.ACCEPTED': 'Accepted',
    'tripStatus.ON_WAY': 'On Way',
    'tripStatus.ON_SITE': 'On Site',
    ...
    'errors.fileMissing': 'The file is no longer available',
  ...
  pl: {
    ...
    'push.tripStatusTitle': 'Status trasy',
    'push.tripStatusBody': '{{plate}}: {{status}}',
    'tripStatus.ASSIGNED': 'Przypisany',
    'tripStatus.ACCEPTED': 'Zaakceptowany',
    'tripStatus.ON_WAY': 'W drodze',
    'tripStatus.ON_SITE': 'Na miejscu',
    'tripStatus.LOADED': 'Załadowany',
    'tripStatus.DELIVERED': 'Dostarczony',
    'errors.tripNotFound': 'Nie znaleziono trasy',
    'errors.documentNotFound': 'Nie znaleziono dokumentu',
    'errors.fileMissing': 'Plik nie jest już dostępny',
  ...
  lt: {
    ...
    'push.tripStatusTitle': 'Reiso būsena',
    'push.tripStatusBody': '{{plate}}: {{status}}',
    'tripStatus.ASSIGNED': 'Priskirtas',
    'tripStatus.ACCEPTED': 'Priimtas',
    'tripStatus.ON_WAY': 'Kelyje',
    'tripStatus.ON_SITE': 'Vietoje',
    'tripStatus.LOADED': 'Pakrautas',
    'tripStatus.DELIVERED': 'Pristatytas',
    'errors.tripNotFound': 'Reisas nerastas',
    'errors.documentNotFound': 'Dokumentas nerastas',
    'errors.fileMissing': 'Failas nebepasiekiamas',
  ...
  ru: {
    ...
    'push.tripStatusTitle': 'Статус рейса',
    'push.tripStatusBody': '{{plate}}: {{status}}',
    'tripStatus.ASSIGNED': 'Назначен',
    'tripStatus.ACCEPTED': 'Принят',
    'tripStatus.ON_WAY': 'В пути',
    'tripStatus.ON_SITE': 'На месте',
    'tripStatus.LOADED': 'Загружен',
    'tripStatus.DELIVERED': 'Доставлен',
    'errors.tripNotFound': 'Рейс не найден',
    'errors.documentNotFound': 'Документ не найден',
    'errors.fileMissing': 'Файл больше не доступен',
