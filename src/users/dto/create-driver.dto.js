...
class CreateDriverDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String, minLength: 2 }, phone: { required: true, type: () => String, pattern: "^\\+?[\\d\\s\\-()]{8,20}$" }, password: { required: false, type: () => String }, language: { required: false, type: () => Object } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateDriverDto.prototype, "language", void 0);
