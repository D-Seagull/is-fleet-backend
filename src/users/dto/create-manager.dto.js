...
class CreateManagerDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String, format: "email" }, phone: { required: true, type: () => String }, name: { required: false, type: () => String }, language: { required: false, type: () => Object } };
    }
}
...
__decorate([
    ...
    __metadata("design:type", String)
], CreateManagerDto.prototype, "language", void 0);
