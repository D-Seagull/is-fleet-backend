...
export declare class GroupsService {
    ...
    findAll(companyId: string | null, _role: string, _userId: string): Promise<({
        managers: ({
            manager: {
                name: string | null;
                id: string;
    ...
    findAllTrucksGroups(companyId: string | null): Promise<({
        trucks: ({
            truck: {
                id: string;
                plate: string;
    ...
    findAllManagersGroups(companyId: string | null, role?: string, userId?: string): Promise<({
        managers: ({
            manager: {
                name: string | null;
                id: string;
